...
const TimeCountDown: FC<Props> = ({title, start}) => {
  const timeLeft = useCountDownTime(start);

  return (
    <div className="flex flex-col items-center space-y-3 margin-y-3">
      <div className="text-neutral-500 dark:text-neutral-400 flex items-center space-x-2 ">
        ...
        <span className="leading-none mt-1">{title}</span>
      </div>
