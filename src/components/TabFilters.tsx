...
const TabFilters: FC<TabFiltersProps> = ({setFilterOptions}) => {
  ...
  useEffect(() => {
    const _saleType = saleTypeStates.length <= 0 ? "Non" : 
                      saleTypeStates.includes("All Sale Types") ? "All" :
                      saleTypeStates.includes("Buy now") && saleTypeStates.includes("On Auction") ? "All" :
                      saleTypeStates.includes("Buy now") ? "Buy now" : "On Auction"
    console.log("sniper: filter: ", rangePrices, saleTypeStates, sortOrderStates, _saleType)
    setFilterOptions && setFilterOptions({
      ...
      saleType: _saleType,
      sort: sortOrderStates ? sortOrderStates : "Non"
    })
  }, [rangePrices, saleTypeStates, setFilterOptions, sortOrderStates])
