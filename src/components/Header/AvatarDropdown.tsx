...
export default function AvatarDropdown() {
  ...
  var account = "";
  if(web3Context?.account !== undefined) {
    ...
    <div className="AvatarDropdown">
      <Popover className="relative">
        {({ open }) => (
          <>
            <Popover.Button
              className={`relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium px-4 py-2 sm:px-5   border bg-white border-neutral-200 text-neutral-700 dark:bg-neutral-900 dark:text-neutral-300 dark:border-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-800   focus:outline-none focus:ring-offset-2 focus:ring-primary-6000 dark:focus:ring-offset-0`}
            >
              {/* <ButtonSecondary sizeClass="px-4 py-2 sm:px-5"> */}
                <Jazzicon diameter={16} seed={parseInt(account.slice(2, 10), 16)} /> 
                <span style={{paddingLeft: '10px'}}>{formatAddress(web3Context?.account)}</span>
              {/* </ButtonSecondary> */}
              {/* <Avatar
                imgUrl={avatarImgs[7]}
            ...
            {/* <ButtonSecondary sizeClass="px-4 py-2 sm:px-5"><Jazzicon diameter={16} seed={parseInt(account.slice(2, 10), 16)} /> <span style={{paddingLeft: '5px'}}>{formatAddress(web3Context?.account)}</span></ButtonSecondary> */}
            <Transition
              as={Fragment}
                  ...
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-grow">
                        ...
                        <h4 className="font-semibold">{formatAddress(web3Context?.account)}</h4>
                      </div>
                    </div>
                    ...
                    {/* ------------------ 1 --------------------- */}
                    <Link
                      to={`/profile/${web3Context?.account}`}
