...
const TimeCountDown: React.FC<Props> = ({end}) => {
  const timeLeft = useCountDownTime(end);
  ...
  return (
    <div className="space-y-5">
      <div className="text-neutral-500 dark:text-neutral-400 flex items-center space-x-2 ">
        ...
        <span className="leading-none mt-1">{Date.now() < end * 1000? "Auction ending in:" : "Auction was already Ended."}</span>
      </div>
      {Date.now() < end * 1000 && <div className="flex space-x-5 sm:space-x-10">
